...
import (
	...
	behaviorserviceServer "github.com/ziptako/behavior/internal/server/behaviorservice"
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		behavior.RegisterBehaviorServiceServer(grpcServer, behaviorserviceServer.NewBehaviorServiceServer(ctx))
